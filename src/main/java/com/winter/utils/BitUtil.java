...
public class BitUtil {
    ...
    public static  String send(WalletAppKit walletAppKit, String recipientAddress, String amount){
        NetworkParameters params = getParams();
        String err = "";
        if(recipientAddress.isEmpty() || recipientAddress.equals("Scan recipient QR")) {
    ...
    public static NetworkParameters getParams(){
        return true ? MainNetParams.get() : TestNet3Params.get();
    }
...
//       byte[] bytes = MnemonicCode.toSeed(mnemonicCode, "123456");
    ...
    //通过助记词
    public static WalletAppKit getWalletKit(Context context,File file, String seedcode){
        WalletAppKit walletAppKit = new WalletAppKit(getParams(), file, "kpc_wallet") {
            @Override
...
//        }
    ...
    public static  void Signingtrasaction(String wif, String msg) {
      ...
      //      Log.e("wif check", String.valueOf(wif.equals(check)));
           ...
           // String hex = util.Base64.encodeToString(res, 16);
